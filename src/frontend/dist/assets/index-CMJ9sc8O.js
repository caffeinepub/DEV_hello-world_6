...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "absolute inset-0 opacity-40",
          style: {
            backgroundImage: "url(/assets/generated/hero-wash.dim_1200x800.jpg)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "radial-gradient(ellipse at center, transparent 40%, oklch(0.99 0.005 260 / 0.6) 100%)"
          },
          "aria-hidden": "true"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold tracking-widest uppercase text-primary/70 mb-6 opacity-0 animate-slide-up [animation-delay:100ms] [animation-fill-mode:forwards]", children: "Welcome" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-6xl md:text-8xl font-bold tracking-tight text-foreground mb-6 opacity-0 animate-slide-up [animation-delay:200ms] [animation-fill-mode:forwards]", children: [
              "Hello, ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient italic", children: "World!" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg md:text-xl text-muted-foreground leading-relaxed max-w-md opacity-0 animate-slide-up [animation-delay:350ms] [animation-fill-mode:forwards]", children: "A clean place to start. Simple, intentional, and always ready for what comes next." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-6 px-8 border-t border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm text-muted-foreground font-body", children: [
      "\\u00a9 ",
